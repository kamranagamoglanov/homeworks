...
# double = list(map(double_number, [1,2,3]))
# print(double)
...
# def celsius_fahrenheit_converter(num):
#     return (num * 1.8) + 32

# celsius = list(map(celsius_fahrenheit_converter, [10, 22, 39.9]))
# print(celsius)
...
# square_nums = list(map(square_root, [4, 9, 16, 25, 121]))
# print(square_nums)
...
# names = list(map(hello_name, ["Mark", "Bob", "Tony"]))
# print(names)
...
# def power_series(num, e):
#     power = list(map(lambda x: [x**i for i in range(e + 1)], num))
#     print(power)

# nums = [2, 4, 6]
# power = 3
# power_series(nums, power)
...
# def two_list_concatenate(num, e):
#     concatenate = list(map(lambda r1, r2: r1 + r2, row_one, row_two))
#     print(concatenate)
    
# row_one = ["a", "x", 6]
# row_two = ["b", "y", 5]
# two_list_concatenate(row_one, row_two)


"""G. Create a function that takes a list of floats and uses the map() function to round each float 
to a specified number of decimal places.
"""
# def power_series(float_n, dec_fra):
#     power = list(map(lambda x: round(x, dec_fra), float_n))
#     print(power)

# float_numbers = [1.2345, 6.789, 8.90123, 10.1234578]
# decimal_fractions = 1
# power_series(float_numbers, decimal_fractions)



"""H. Write a function that takes a list of prices and uses map() to apply a
discount percentage to each price."""


# def discount_percentage(price, percent):
#     percentage_part = list(map(lambda  x: (x * (percent / 100)), price))
#     price_part = list(map(lambda  x, y: x - y, price, percentage_part))
#     print(price_part)

# price = [100, 20, 30]
# percent = 5
# discount_percentage(price, percent)
...
"""K. Write a function that takes a list of strings and uses map() to return a 
list of lengths for each string.
"""
# def string_lengths(word):
#     print(list(map(len, word)))

# word = ["Mark", "kiwi", "eight", "Mercedes"]
# string_lengths(word)
...
#     return tuple(string for string in word if palindrom(string))

# lst = ["dad", "coni", "python", "tet-a-tet"]
# print(is_palindrom(lst))
...
#     {"name": "Deny", "salary": 6600},
#     {"name": "Tony", "salary": 2500},
#     {"name": "Terry", "salary": 4500},
#     {"name": "Samuel", "salary": 1500}
    
# ]

# salary_limit = 2800
# salaries = list(filter(lambda x: x["salary"] > salary_limit, name_salaries))
# print(salaries)
...
"""
# def file_names(f_name, tail):
#     return list(filter(lambda x: x.endswith(f".{tail}"), f_name))

# f_name = ["main.py", "test.txt", "adobe.pdf", "document.doc", "blank.txt", "list.doc", "fruit.xls"]
# print(file_names(f_name, "doc"))
...
#     {"name": "Tony", "grade": 90},
#     {"name": "Terry", "grade": 35},
#     {"name": "Samuel", "grade": 85}
    
# ]

# grade_limit = 50
# grades = list(filter(lambda x: x["grade"] > grade_limit, student_grades))
# print(grades)
...
#     reversed_dictionary = {value: key for key, value in reversed(x.items())}
